...
git branch -M main
git remote add origin git@github.com:ThijsVroegh/practice
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/ThijsVroegh/repositories/new](https://github.com/organizations/ThijsVroegh/repositories/new)
and create a new repository named `practice` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/ThijsVroegh/practice/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
